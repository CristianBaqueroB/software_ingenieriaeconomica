...
class PagarCuotaAmericana extends StatefulWidget {
  @override
  _PagarCuotaAmericanaState createState() => _PagarCuotaAmericanaState();
}

class _PagarCuotaAmericanaState extends State<PagarCuotaAmericana> {
  List<PrestamoAmericana> _prestamos = [];
  PrestamoAmericana? _prestamoSeleccionado;
    ...
    if (user != null) {
      try {
        ...
        QuerySnapshot snapshot = await FirebaseFirestore.instance
            ...
            .where('tipo_prestamo', isEqualTo: 'Amortización Americana')
            .where('cedula', isEqualTo: cedula)
            .get();

        setState(() {
          _prestamos = snapshot.docs.map((doc) {
            return PrestamoAmericana(
              id: doc.id,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Pagar Cuota Amortización Americana')),
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      DropdownButtonFormField<PrestamoAmericana>(
                        decoration: InputDecoration(
                          labelText: 'Selecciona un Préstamo',
                          border: OutlineInputBorder(),
                        ),
                        value: _prestamoSeleccionado,
                        onChanged: (PrestamoAmericana? nuevoPrestamo) {
                          setState(() {
                        ...
                        items: _prestamos.map((prestamo) {
                          return DropdownMenuItem<PrestamoAmericana>(
                            value: prestamo,
